...
public class CashCardController {
    ...
    public ResponseEntity<Void> deleteCashCardById(@PathVariable Long requestedId,
                                                   Principal principal) {
        boolean cardExists = cashCardRepository.existsByIdAndOwner(requestedId, principal.getName());
        if (cardExists) {
