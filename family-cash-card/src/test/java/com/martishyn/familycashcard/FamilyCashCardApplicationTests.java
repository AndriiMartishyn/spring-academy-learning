...
class FamilyCashCardApplicationTests {
    ...
    void shouldUpdateAnExistingCashCard() {
        ...
        ResponseEntity<String> getResponseOfUpdatedCashCard = testRestTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards/99", String.class);
        assertThat(getResponseOfUpdatedCashCard.getStatusCode()).isEqualTo(HttpStatus.OK);

        DocumentContext documentContext = JsonPath.parse(getResponseOfUpdatedCashCard.getBody());
        Number id = documentContext.read("$.id");
        assertThat(id).isEqualTo(99);
        Double amount = documentContext.read("$.amount");
    ...
    @Test
    void shouldNotUpdateCashCardOwnedBySomeOneElse() {
    ...
    void shouldDeleteAnExistingCashCard() {
        ...
        ResponseEntity<String> responseFromDeletedCard = testRestTemplate
                .withBasicAuth("sarah1", "abc123")
                .getForEntity("/cashcards/99", String.class);
        assertThat(responseFromDeletedCard.getStatusCode()).isEqualTo(HttpStatus.NOT_FOUND);
    }

    @Test
    void shouldNotDeleteNonExistingCashCard() {
        ResponseEntity<Void> response = testRestTemplate
                .withBasicAuth("sarah1", "abc123")
    ...
    @Test
    void shouldNotAllowDeletionOfCashCardUserDontOwn(){
        ResponseEntity<Void> response = testRestTemplate
                .withBasicAuth("sarah1", "abc123")
